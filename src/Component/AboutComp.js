...
const AboutComp = props => {
  ...
  return (
    <div className={classes.root} id="about">
      ...
      >
        <Grid item md={3} xs={12}>
          <img
            ...
            src="https://avatars0.githubusercontent.com/u/18033231?s=400&u=d6c67f6df5525b6c6a99011c55355efad87ce5c1&v=4"
          />
        </Grid>
      ...
      >
        <Grid item>
          <a href="https://www.facebook.com/yash.ladha.7">
            <SvgIcon
        ...
        <Grid item>
          <a href="https://twitter.com/yashLadha_">
            <SvgIcon
              style={{ width: '24px', height: '24px' }}
              viewBox="0 0 24 24"
            >
